...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Create the schema manually to ensure it's ready before Hibernate processes ddl-auto
        try {
            entityManager.createNativeQuery(
                "CREATE TABLE IF NOT EXISTS contact (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, first_name VARCHAR(50), last_name VARCHAR(50), email VARCHAR(100), phone_number VARCHAR(20), address VARCHAR(255), category VARCHAR(50))"
            ).executeUpdate();
        } catch (Exception e) {
